...
import { ToolboxItems } from "@/components/ToolboxItems";  // Correct import path
...
export const AboutSection = () => {
  ...
  return <div className="py-20 lg:py-28">
    ...
    <SectionHeader eyebrow="About Me" title="A Glimpse Into My World" description="Learn more about who I am, what I do, and inspires me."/>
...
<Image src={bookImage} alt="Book cover"  />
    ...
    <CardHeader title="My Toolbox" description="Explore the technologies and tools I use for building intelligent solutions."  className="" />
